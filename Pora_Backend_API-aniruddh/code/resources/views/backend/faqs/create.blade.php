    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('backend.faqs.store') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="vQuestionCategory"
                                        placeholder="Enter Question Category" value="{{ old('vQuestionCategory') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="vQuestion"
                                        placeholder="Enter Question" value="{{ old('vQuestion') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="txAnswer" id="txAnswer" rows="3"
                                        class="form-control ckeditor">{{ old('txAnswer') }}</textarea>
